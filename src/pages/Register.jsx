    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          >
            {loading
              ? <><div className="spinner" style={{ width: 18, height: 18 }} /> Registering…</>
              : <><ArrowRight size={17} /> Register</>}
          </button>
        </form>

        <p className="auth-footer-text" style={{ marginTop: '1.5rem' }}>
          Already have an account?{' '}
          <Link to="/login" className="link-btn link-btn--accent">Login</Link>
        </p>
      </div>
    </div>
  )
